  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          <form action="/disposisi/store" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-md-6 col-12">
                <div class="mb-1">
                   ...
                   <label class="form-label" for="basic">Nomor Dokumen</label>
                    <select name="surat_id" class="select2 form-select" id="basic">
              ...
              <div class="col-md-6 col-12">
                <div class="mb-1">
                  ...
                  <label class="form-label" for="fp-default">Tanggal</label>
                    <input type="text" name="tanggal_terima" id="fp-default" class="form-control flatpickr-basic" placeholder="Tahun-Bulan-Hari" />
                </div>
              </div>
              <div class="col-md-6 col-12">
                <div class="mb-1">
